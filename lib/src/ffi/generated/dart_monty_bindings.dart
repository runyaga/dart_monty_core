...
>(symbol: 'monty_repl_resume_with_exception')
external int _monty_repl_resume_with_exception(
  ffi.Pointer<MontyReplHandle> handle,
  ffi.Pointer<ffi.Char> exc_type,
  ffi.Pointer<ffi.Char> error_message,
  ffi.Pointer<ffi.Pointer<ffi.Char>> out_error,
...
MontyProgressTag monty_repl_resume_with_exception(
  ffi.Pointer<MontyReplHandle> handle,
  ffi.Pointer<ffi.Char> exc_type,
  ffi.Pointer<ffi.Char> error_message,
  ffi.Pointer<ffi.Pointer<ffi.Char>> out_error,
) => MontyProgressTag.fromValue(
  _monty_repl_resume_with_exception(
    handle,
    exc_type,
    error_message,
    out_error,
